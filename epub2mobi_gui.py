...
# 创建和放置标签
Label(root, text="EPUB文件夹(epub-path):").grid(row=0, column=0, padx=10, pady=5)
Label(root, text="MOBI文件夹(mobi-path):").grid(row=1, column=0, padx=10, pady=5)
Label(root, text="线程数(max-workers):").grid(row=2, column=0, padx=10, pady=5)
